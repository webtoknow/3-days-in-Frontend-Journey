# Day 1 - My Travels page exercises
...
```SH
cd 4-days-in-Frontend-Journey/Day-1_HTML-CSS/Exercises/Code
```
...
In the document we need the define a HTML document structure.
